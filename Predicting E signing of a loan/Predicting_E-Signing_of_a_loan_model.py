""" Predicting the Likelihood of E-Signing
    a loan Based on Financial History Model """
...
dataset[['personal_account_m', 'personal_account_months', 'personal_account_y']].head()
...
""" Formatting the Results """ # entropy model is the best one
